...
instr_func opcode_entry[256] = {
    ...
    /* 0x08 - 0x0b*/ inv, or_r2rm_v, or_rm2r_b, inv,// 24.4.5 添加 or(2_10) 指令
    ...
    /* 0x2c - 0x2f*/ sub_i2a_b, inv, inv, inv,
    ...
    /* 0x58 - 0x5b*/ pop_r_v, pop_r_v, pop_r_v, pop_r_v, /* 24.4.5 添加 pop(2_8) 指令 */
    /* 0x5c - 0x5f*/ pop_r_v, pop_r_v, pop_r_v, pop_r_v,
    /* 0x60 - 0x63*/ inv, inv, inv, inv,
    /* 0x64 - 0x67*/ inv, inv, data_size_16, inv,
    /* 0x68 - 0x6b*/ push_i_v, inv, push_i_b, inv, // 24.4.5 push(3_1)
    ...
    /* 0x8c - 0x8f*/ inv, lea, mov_rm2sr_v, inv, /* 24.4.3 添加lea(10) 指令 */
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_imm16, ret, /* 24.4.2 添加ret(5) */
    ...
    /* 0xe8 - 0xeb*/ call_near, jmp_near, ljmp, jmp_byte, /* 24.4.2 添加call_near(4) jmp_near(1) jmp_byte(7) */
...
{
	add_i2rm_v, // opcode 0x0 24.4.2 添加add(6)指令
	inv, 
	inv, 
	inv, 
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x1c - 0x1f*/ inv, inv, inv, inv,
    /* 0x20 - 0x23*/ mov_cr2rm_v, inv, inv, inv,
    /* 0x24 - 0x27*/ inv, inv, inv, inv,
    ...
    /* 0x84 - 0x87*/ je_near, jne_near, jbe_near, ja_near, // 24.4.5 添加jbe(2_3) 指令
