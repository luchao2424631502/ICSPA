...
instr_func opcode_entry[256] = {
    ...
    /* 0x74 - 0x77*/ inv, inv, jmp_short_BE, inv, /* 24.4.3 添加jmp_short_BE 指令 */
    ...
    /* 0x8c - 0x8f*/ inv, inv, inv, inv, /* 24.4.3 添加lea 指令 */
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, inv, ret, /* 24.4.2 添加ret */
